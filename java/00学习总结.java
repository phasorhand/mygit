...
项目驱动
踏实记录-简化-结构化-记忆-实践-纠错
知乎 谢龙 https://www.zhihu.com/question/29581524/answer/44872235
...
入门（1-2 个月）
	...
	* 
		...
		* 掌握 JDK 以外的常用类库和工具包。JDK 原生 API 在很多场景下使用并不方便。你需要掌握社区贡献的优秀类库和工具包，比如 apache commons、google guava 等，具体可以翻阅 服务端技术选型的Utility 篇。
